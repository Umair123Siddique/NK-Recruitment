        ...
        <div className="mb-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="mb-6 inline-block">
              {/* <div className="relative h-12 w-40"> */}
                <div className="flex items-center gap-2">
                  ...
                  />
                  <div>
                    <div className="text-xl font-bold text-[#1869A3]">
                      RECRUITMENT{" "}
                    </div>
                    <div className="text-[10px] font-bold text-[#1869A3]">
            ...
            <p className="mb-6 text-gray-400">
              NK Recruitment is a leading recruitment agency specializing in
              connecting talented professionals with premier job opportunities
              worldwide.
            </p>
            <div className="flex space-x-4">
              <Link
                href="https://facebook.com"
                className="hover:bg-primary rounded-full bg-gray-800 p-2 transition-colors"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col items-center justify-between md:flex-row">
            <p className="text-center text-gray-400 md:text-left">
              &copy; {new Date().getFullYear()} NK Recruitment. All rights
              reserved.
            </p>
